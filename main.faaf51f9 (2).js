        ...
        !function() {
            ...
            function l(t) {
                ...
                t.styles || (t.styles = {
                    ...
                    transform: {},
                    computed: {}
                }, t.styles.inline = t.domEl.getAttribute("style") || "", t.styles.inline += "; visibility: visible; ", t.styles.computed.opacity = e.opacity, e.transition && "all 0s ease 0s" !== e.transition ? t.styles.computed.transition = e.transition + ", " : t.styles.computed.transition = ""),
            ...
            function m() {
                ...
                N.tools.forOwn(N.store.elements, function(n) {
                    e = N.store.elements[n],
                    t = w(e),
                    x(e) ? (e.config.beforeReveal(e.domEl), t ? e.domEl.setAttribute("style", e.styles.inline + e.styles.transform.target + e.styles.transition.delayed) : e.domEl.setAttribute("style", e.styles.inline + e.styles.transform.target + e.styles.transition.instant), b("reveal", e, t), e.revealing = !0, e.seen = !0, e.sequence && y(e, t)) : T(e) && (e.config.beforeReset(e.domEl), e.domEl.setAttribute("style", e.styles.inline + e.styles.transform.initial + e.styles.transition.instant), b("reset", e), e.revealing = !1)
                })
            }
            function y(t, e) {
                var n = 0,
            ...
            o.prototype.reveal = function(t, e, n, i) {
                ...
                for (var y = 0; y < u.length; y++)
                    ...
                    l(p),
                    f(p),
                    N.tools.isMobile() && !p.config.mobile || !N.isSupported() ? (p.domEl.setAttribute("style", p.styles.inline), p.disabled = !0) : p.revealing || p.domEl.setAttribute("style", p.styles.inline + p.styles.transform.initial);
            ...
            +function(t) {
                ...
                n.prototype.getState = function(t, e, n, i) {
                    ...
                    if ("bottom" == this.affixed)
                        return null != n ? !(o + this.unpin <= s.top) && "bottom" : !(o + r <= t - i) && "bottom";
        ...
        (function(t) {
            function i() {
                t(".navbar-toggle").click(function(e) {
                    e.preventDefault(),
                    t(".navbar-collapse").toggleClass("active")
                }),
                ...
                r.prototype.toggle = function(i) {
                    ...
                    if (!o.is(".disabled, :disabled")) {
                        ...
                        if (n(), !r) {
                            ...
                            if (s.trigger(i = t.Event("show.bs.dropdown", a)), i.isDefaultPrevented())
                                return;
                    ...
                    if (/(38|40|27|32)/.test(n.which) && !/input|textarea/i.test(n.target.tagName)) {
                        ...
                        if (n.preventDefault(), n.stopPropagation(), !i.is(".disabled, :disabled")) {
                            ...
                            if (!r && 27 != n.which || r && 27 == n.which)
                                return 27 == n.which && o.find(s).trigger("focus"), i.trigger("click");
        ...
        !function(e, n) {
            ...
            function w(t, e) {
                for (var n, i, o = [], s = 0, r = t.length; s < r; s++)
                    i = t[s],
                    i.style && (n = i.style.display, e ? ("none" === n && (o[s] = Ft.get(i, "display") || null, o[s] || (i.style.display = "")), "" === i.style.display && zt(i) && (o[s] = x(i))) : "none" !== n && (o[s] = "none", Ft.set(i, "display", n)));
                for (s = 0; s < r; s++)
            ...
            function E(t, e, n, i, o) {
                for (var s, r, a, c, l, u, p = e.createDocumentFragment(), f = [], d = 0, h = t.length; d < h; d++)
                    if ((s = t[d]) || 0 === s)
                        if ("object" === yt.type(s))
                            yt.merge(f, s.nodeType ? [s] : s);
                        else if (Jt.test(s)) {
                            for (r = r || p.appendChild(e.createElement("div")), a = (Gt.exec(s) || ["", ""])[1].toLowerCase(), c = Kt[a] || Kt._default, r.innerHTML = c[1] + yt.htmlPrefilter(s) + c[2], u = c[0]; u--;)
                                r = r.lastChild;
            ...
            function L(t, e, n, i) {
                ...
                if (g || f > 1 && "string" == typeof h && !mt.checkClone && se.test(h))
                    return t.each(function(o) {
                        var s = t.eq(o);
                        g && (e[0] = h.call(this, o, s.html())),
                        L(s, e, n, i)
                    });
                if (f && (o = E(e, t[0].ownerDocument, !1, t, i), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
                    for (a = yt.map(T(o, "script"), $), c = a.length; p < f; p++)
                        l = o,
                        p !== d && (l = yt.clone(l, !0, !0), c && yt.merge(a, T(l, "script"))),
                        n.call(t[p], l, p);
                    if (c)
                        for (u = a[a.length - 1].ownerDocument, yt.map(a, j), p = 0; p < c; p++)
                            l = a[p],
                            Qt.test(l.type || "") && !Ft.access(l, "globalEval") && yt.contains(u, l) && (l.src ? yt._evalUrl && yt._evalUrl(l.src) : r(l.textContent.replace(ae, ""), u))
                }
                return t
            }
            function R(t, e, n) {
            ...
            function M(t, e, n, i, o) {
                ...
                for (s = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; s < 4; s += 2)
                    ...
                    i ? ("content" === n && (r -= yt.css(t, "padding" + _t[s], !0, o)), "margin" !== n && (r -= yt.css(t, "border" + _t[s] + "Width", !0, o))) : (r += yt.css(t, "padding" + _t[s], !0, o), "padding" !== n && (r += yt.css(t, "border" + _t[s] + "Width", !0, o)));
                return r
            }
            function U(t, e, n) {
                var i,
            ...
            function X(t, e, n) {
                ...
                n.queue || (r = yt._queueHooks(t, "fx"), null == r.unqueued && (r.unqueued = 0, a = r.empty.fire, r.empty.fire = function() {
                    ...
                    f.always(function() {
                        r.unqueued--,
                        yt.queue(t, "fx").length || r.empty.fire()
                    })
                }));
                for (i in e)
                    if (o = e[i], be.test(o)) {
                ...
                if ((c = !yt.isEmptyObject(e)) || !yt.isEmptyObject(d)) {
                    ...
                    c = !1;
                    for (i in d)
                        c || (v ? "hidden" in v && (g = v.hidden) : v = Ft.access(t, "fxshow", {
                            display: l
            ...
            function Q(t, e, n) {
                var i,
                    ...
                    c = function() {
                        if (o)
                            return !1;
                        for (var e = me || z(), n = Math.max(0, l.startTime + l.duration - e), i = n / l.duration || 0, s = 1 - i, r = 0, c = l.tweens.length; r < c; r++)
                            l.tweens[r].run(s);
                ...
                for (G(u, l.opts.specialEasing); s < r; s++)
                    if (i = Q.prefilters[s].call(l, t, u, l.opts))
                        return yt.isFunction(i.stop) && (yt._queueHooks(l.elem, l.opts.queue).stop = yt.proxy(i.stop, i)), i;
            ...
            function ot(t, e, n, i) {
                ...
                if (u[1])
                    for (r in t.converters)
                        l[r.toLowerCase()] = t.converters[r];
                for (s = u.shift(); s;)
                ...
                for ("boolean" == typeof r && (l = r, r = arguments[a] || {}, a++), "object" == typeof r || yt.isFunction(r) || (r = {}), a === c && (r = this, a--); a < c; a++)
                    if (null != (t = arguments[a]))
                        for (e in t)
                            n = r[e],
                            i = t[e],
                            r !== i && (l && i && (yt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, s = n && Array.isArray(n) ? n : []) : s = n && yt.isPlainObject(n) ? n : {}, r[e] = yt.extend(l, s, i)) : void 0 !== i && (r[e] = i));
                return r
            },
            yt.extend({
                ...
                proxy: function(t, e) {
                    ...
                    if ("string" == typeof e && (n = t[e], e = t, t = n), yt.isFunction(t))
                        return i = ct.call(arguments, 2), o = function() {
            ...
            var Ct = function(t) {
                    ...
                    if (!i && ((e ? e.ownerDocument || e : H) !== j && $(e), e = e || j, I)) {
                        if (11 !== h && (c = gt.exec(t)))
                            if (o = c[1]) {
                                if (9 === h) {
                                    ...
                                    if (r.id === o)
                                        return n.push(r), n
                                } else if (d && (r = d.getElementById(o)) && P(e, r) && r.id === o)
                                    return n.push(r), n
                            } else {
                                if (c[2])
                        ...
                        if (x.qsa && !_[t + " "] && (!L || !L.test(t))) {
                            if (1 !== h)
                                ...
                                for ((a = e.getAttribute("id")) ? a = a.replace(bt, xt) : e.setAttribute("id", a = F), u = E(t), s = u.length; s--;)
                                    u[s] = "#" + a + " " + p(u[s]);
                                f = u.join(","),
                ...
                function f(t, e, n) {
                    ...
                    return e.first ? function(e, n, o) {
                        ...
                        if (c) {
                            for (; e = e[i];)
                                if ((1 === e.nodeType || r) && t(e, n, c))
                                    return !0
                        } else
                            for (; e = e[i];)
                                if (1 === e.nodeType || r)
                                    if (p = e[F] || (e[F] = {}), u = p[e.uniqueID] || (p[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase())
                                        e = e[i] || e;
                                    else {
                                        if ((l = u[s]) && l[0] === W && l[1] === a)
                                            return f[2] = l[2];
                                        if (u[s] = f, f[2] = t(e, n, c))
                                            return !0
                                    }
                        return !1
                    }
                    ...
                    return o && !o[F] && (o = v(o)), s && !s[F] && (s = v(s, r)), i(function(i, r, a, c) {
                        ...
                        if (i) {
                            if (s || t) {
                                ...
                                for (u = b.length; u--;)
                                    (p = b[u]) && (l = s ? J(i, p) : f[u]) > -1 && (i[l] = !(r[l] = p))
                            }
                        } else
                            b = g(b === r ? b.splice(v, b.length) : b),
                            s ? s(null, r, b, c) : Q.apply(r, b)
                    })
                }
                function m(t) {
                    ...
                    var o = n.length > 0,
                        ...
                        r = function(i, r, a, c, l) {
                            ...
                            if (d += h, o && h !== d) {
                                ...
                                Q.apply(c, m),
                                l && !i && m.length > 0 && d + n.length > 1 && e.uniqueSort(c)
                            }
                            return l && (W = x, D = y), v
                        };
                    return o ? i(r) : r
                ...
                $ = e.setDocument = function(t) {
                    ...
                    return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, O = j.documentElement, I = !C(j), H !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", wt, !1) : n.attachEvent && n.attachEvent("onunload", wt)), x.attributes = o(function(t) {
                        ...
                        var n,
                            ...
                            c = [e];
                        if (!o || !s)
                            return t === j ? -1 : e === j ? 1 : o ? -1 : s ? 1 : N ? J(N, t) - J(N, e) : 0;
                        if (o === s)
                            return r(t, e);
                ...
                w = e.selectors = {
                            ...
                            return 1 === i && 0 === o ? function(t) {
                                ...
                                if (v) {
                                    ...
                                    if (h = [r ? v.firstChild : v.lastChild], r && y) {
                                        ...
                                        for (; (f = ++d && f && f[g] || (b = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++b || (y && (p = f[F] || (f[F] = {}), u = p[f.uniqueID] || (p[f.uniqueID] = {}), u[t] = [W, b]), f !== e));)
                                            ;
                    ...
                    pseudos: {
                        ...
                        lang: i(function(t) {
                            return ut.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(mt, yt).toLowerCase(), function(e) {
                                var n;
                                do {
                ...
                return u.prototype = w.filters = w.pseudos, w.setFilters = new u, E = e.tokenize = function(t, n) {
                    ...
                    for (a = t, c = [], l = w.preFilter; a;) {
                        i && !(o = rt.exec(a)) || (o && (a = a.slice(o[0].length) || a), c.push(s = [])),
                        i = !1,
                        (o = at.exec(a)) && (i = o.shift(), s.push({
                            value: i,
                            type: o[0].replace(st, " ")
                        }), a = a.slice(i.length));
                        for (r in w.filter)
                            !(o = pt[r].exec(a)) || l[r] && !(o = l[r](o)) || (i = o.shift(), s.push({
                                value: i,
                                type: r,
                                matches: o
                            }), a = a.slice(i.length));
                    ...
                    if (n = n || [], 1 === f.length) {
                        if (s = f[0] = f[0].slice(0), s.length > 2 && "ID" === (r = s[0]).type && 9 === e.nodeType && I && w.relative[s[1].type]) {
                            if (!(e = (w.find.ID(r.matches[0].replace(mt, yt), e) || [])[0]))
                                return n;
                            u && (e = e.parentNode),
            ...
            (yt.fn.init = function(t, e, n) {
                ...
                if (n = n || At, "string" == typeof t) {
                    if (!(i = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : $t.exec(t)) || !i[1] && e)
                    ...
                    c = function() {
                        for (o = o || t.once, i = e = !0; r.length; a = -1)
                            for (n = r.shift(); ++a < s.length;)
                                !1 === s[a].apply(n[0], n[1]) && t.stopOnFalse && (a = s.length, n = !1);
                        t.memory || (n = !1),
                        e = !1,
                        o && (s = n ? [] : "")
                    },
            ...
            yt.extend({
                    ...
                    var e = [["notify", "progress", yt.Callbacks("memory"), yt.Callbacks("memory"), 2], ["resolve", "done", yt.Callbacks("once memory"), yt.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", yt.Callbacks("once memory"), yt.Callbacks("once memory"), 1, "rejected"]],
                        ...
                        o = {
                            ...
                            then: function(t, i, o) {
                                        ...
                                        var a = this,
                                            ...
                                            l = function() {
                                                ...
                                                if (!(t < r)) {
                                                    ...
                                                    yt.isFunction(l) ? o ? l.call(n, s(r, e, f, o), s(r, e, d, o)) : (r++, l.call(n, s(r, e, f, o), s(r, e, d, o), s(r, e, f, e.notifyWith))) : (i !== f && (a = void 0, c = [n]), (o || e.resolveWith)(a, c))
                                                }
                                            },
                                            u = o ? l : function() {
                                                try {
                                                    ...
                                                    t + 1 >= r && (i !== d && (a = void 0, c = [n]), e.rejectWith(a, c))
                                                }
                                            };
                                ...
                                var r = 0;
                                return yt.Deferred(function(n) {
                                    e[0][3].add(s(0, n, yt.isFunction(o) ? o : f, n.notifyWith)),
                ...
                when: function(t) {
                    ...
                    if (e <= 1 && (h(t, s.done(r(n)).resolve, s.reject, !e), "pending" === s.state() || yt.isFunction(o[n] && o[n].then)))
                        return s.then();
                    for (; n--;)
                        h(o[n], r(n), s.reject);
                    return s.promise()
                ...
                data: function(t, e) {
                    ...
                    if (void 0 === t) {
                        if (this.length && (o = Ht.get(s), 1 === s.nodeType && !Ft.get(s, "hasDataAttrs"))) {
                            for (n = r.length; n--;)
                                r[n] && (i = r[n].name, 0 === i.indexOf("data-") && (i = yt.camelCase(i.slice(5)), y(s, i, o[i])));
            ...
            yt.fn.extend({
                ...
                promise: function(t, e) {
                    ...
                    for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;)
                        (n = Ft.get(s[r], t + "queueHooks")) && n.empty && (i++, n.empty.add(a));
                ...
                add: function(t, e, n, i, o) {
                    ...
                    if (v)
                        for (n.handler && (s = n, n = s.handler, o = s.selector), o && yt.find.matchesSelector(Zt, o), n.guid || (n.guid = yt.guid++), (c = v.events) || (c = v.events = {}), (r = v.handle) || (r = v.handle = function(e) {
                            ...
                            d = g = a[1],
                            h = (a[2] || "").split(".").sort(),
                            d && (p = yt.event.special[d] || {}, d = (o ? p.delegateType : p.bindType) || d, p = yt.event.special[d] || {}, u = yt.extend({
                                type: d,
                                origType: g,
                                data: i,
                                handler: n,
                        ...
                        for (e = (e || "").match(It) || [""], l = e.length; l--;)
                            if (a = ne.exec(e[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                                for (p = yt.event.special[d] || {}, d = (i ? p.delegateType : p.bindType) || d, f = c[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = f.length; s--;)
                                    u = f[s],
                                    !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(s, 1), u.selector && f.delegateCount--, p.remove && p.remove.call(t, u));
                                r && !f.length && (p.teardown && !1 !== p.teardown.call(t, h, v.handle) || yt.removeEvent(t, d, v.handle), delete c[d])
                            } else
                                for (d in c)
                                    yt.event.remove(t, d + e[l], n, i, !0);
                    ...
                    if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                        for (r = yt.event.handlers.call(this, a, l), e = 0; (o = r[e++]) && !a.isPropagationStopped();)
                            for (a.currentTarget = o.elem, n = 0; (s = o.handlers[n++]) && !a.isImmediatePropagationStopped();)
                                a.rnamespace && !a.rnamespace.test(s.namespace) || (a.handleObj = s, a.data = s.data, void 0 !== (i = ((yt.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, c)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
                        ...
                        for (; l !== this; l = l.parentNode || this)
                            if (1 === l.nodeType && ("click" !== t.type || !0 !== l.disabled)) {
                                for (s = [], r = {}, n = 0; n < c; n++)
                                    i = e[n],
                                    o = i.selector + " ",
                                    void 0 === r[o] && (r[o] = i.needsContext ? yt(o, this).index(l) > -1 : yt.find(o, this, null, [l]).length),
                                    r[o] && s.push(i);
                                s.length && a.push({
                                    elem: l,
                                    handlers: s
            ...
            yt.Event = function(t, e) {
                ...
                t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? k : S, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t,
                e && yt.extend(this, e),
            ...
            yt.extend({
                ...
                clone: function(t, e, n) {
                    ...
                    if (e)
                        if (n)
                            for (s = s || T(t), r = r || T(a), i = 0, o = s.length; i < o; i++)
                                O(s[i], r[i]);
                        else
                            O(t, a);
            ...
            yt.each({
                ...
                yt.fn[t] = function(t) {
                    for (var n, i = [], o = yt(t), s = o.length - 1, r = 0; r <= s; r++)
                ...
                style: function(t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        var o,
                            ...
                            c = fe.test(e),
                            l = t.style;
                        if (c || (e = H(a)), r = yt.cssHooks[e] || yt.cssHooks[a], void 0 === n)
                            return r && "get" in r && void 0 !== (o = r.get(t, !1, i)) ? o : l[e];
                        s = typeof n,
                        "string" === s && (o = Bt.exec(n)) && o[1] && (n = b(t, e, o), s = "number"),
                        null != n && n === n && ("number" === s && (n += o && o[3] || (yt.cssNumber[a] ? "" : "px")), mt.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), r && "set" in r && void 0 === (n = r.set(t, n, i)) || (c ? l.setProperty(e, n) : l[e] = n))
                    }
                },
            ...
            yt.each(["height", "width"], function(t, e) {
                yt.cssHooks[e] = {
                    get: function(t, n, i) {
                        if (n)
                            return !pe.test(yt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? U(t, e, i) : Yt(t, de, function() {
                                return U(t, e, i)
                            })
                    },
                    set: function(t, n, i) {
            ...
            yt.cssHooks.marginLeft = P(mt.reliableMarginLeft, function(t, e) {
                if (e)
                    return (parseFloat(q(t, "marginLeft")) || t.getBoundingClientRect().left - Yt(t, {
                        marginLeft: 0
                    }, function() {
                ...
                finish: function(t) {
                    return !1 !== t && (t = t || "fx"), this.each(function() {
                        var e,
                            ...
                            s = yt.timers,
                            r = i ? i.length : 0;
                        for (n.finish = !0, yt.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = s.length; e--;)
            ...
            yt.extend({
                attr: function(t, e, n) {
                    var i,
                        ...
                        s = t.nodeType;
                    if (3 !== s && 8 !== s && 2 !== s)
                        return void 0 === t.getAttribute ? yt.prop(t, e, n) : (1 === s && yt.isXMLDoc(t) || (o = yt.attrHooks[e.toLowerCase()] || (yt.expr.match.bool.test(e) ? we : void 0)), void 0 !== n ? null === n ? void yt.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : (i = yt.find.attr(t, e), null == i ? void 0 : i))
                },
                attrHooks: {
                    type: {
                        set: function(t, e) {
            ...
            yt.extend({
                prop: function(t, e, n) {
                    var i,
                        ...
                        s = t.nodeType;
                    if (3 !== s && 8 !== s && 2 !== s)
                        return 1 === s && yt.isXMLDoc(t) || (e = yt.propFix[e] || e, o = yt.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e]
                },
                propHooks: {
                    tabIndex: {
                        get: function(t) {
                ...
                toggleClass: function(t, e) {
                    ...
                    return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : yt.isFunction(t) ? this.each(function(n) {
                        ...
                        var e,
                            ...
                            s;
                        if ("string" === n)
                            for (i = 0, o = yt(this), s = t.match(It) || []; e = s[i++];)
                                o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                        else
                            void 0 !== t && "boolean" !== n || (e = J(this), e && Ft.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Ft.get(this, "__className__") || ""))
                    })
                },
                hasClass: function(t) {
                    var e,
            ...
            yt.extend({
                valHooks: {
                    ...
                    select: {
                        ...
                        set: function(t, e) {
                            for (var n, i, o = t.options, s = yt.makeArray(e), r = o.length; r--;)
                                i = o[r],
                                (i.selected = yt.inArray(yt.valHooks.option.get(i), s) > -1) && (n = !0);
                ...
                trigger: function(t, e, i, o) {
                    ...
                    if (r = a = i = i || rt, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(d + yt.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[yt.expando] ? t : new yt.Event(d, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), e = null == e ? [t] : yt.makeArray(e, [t]), p = yt.event.special[d] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, e))) {
                        if (!o && !p.noBubble && !yt.isWindow(i)) {
                            for (c = p.delegateType || d, Se.test(c + d) || (r = r.parentNode); r; r = r.parentNode)
                                f.push(r),
                                a = r;
            ...
            yt.extend({
                ...
                ajax: function(t, e) {
                    ...
                    if (h.data && h.processData && "string" != typeof h.data && (h.data = yt.param(h.data, h.traditional)), et(Me, h, e, C), u)
                        return C;
                    p = yt.event && h.global,
                    ...
                    s = h.url.replace(Re, ""),
                    h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Le, "+")) : (d = h.url.slice(s.length), h.data && (s += (Ae.test(s) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (s = s.replace(qe, "$1"), d = (Ae.test(s) ? "&" : "?") + "_=" + Ne++ + d), h.url = s + d),
            ...
            yt.ajaxPrefilter("json jsonp", function(t, e, i) {
                ...
                if (a || "jsonp" === t.dataTypes[0])
                    return o = t.jsonpCallback = yt.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Xe, "$1" + o) : !1 !== t.jsonp && (t.url += (Ae.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
            ...
            yt.fn.extend({
                offset: function(t) {
                    ...
                    var e,
                        ...
                        s = this[0];
                    if (s)
                        return s.getClientRects().length ? (i = s.getBoundingClientRect(), e = s.ownerDocument, n = e.documentElement, o = e.defaultView, {
            ...
            yt.each({
                ...
                yt.fn[t] = function(i) {
                    return qt(this, function(t, i, o) {
                        var s;
                        if (yt.isWindow(t) ? s = t : 9 === t.nodeType && (s = t.defaultView), void 0 === o)
                            return s ? s[e] : t[i];
